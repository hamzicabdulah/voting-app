    ...
    <Navbar inverse collapseOnSelect>
      ...
      <Navbar.Collapse>
        <Nav pullRight>
          ...
          {sessionStorage.getItem('userData') && <li role="presentation"><a onClick={logout}>Logout</a></li>}
          {!sessionStorage.getItem('userData') && <li role="presentation"><a href="/login">Login</a></li>}
        </Nav>
      </Navbar.Collapse>
    </Navbar>
  );
