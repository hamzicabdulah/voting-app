  ...
  return (
    <div style={style.navbar} className="Navbar">
      ...
      <div style={style.linksContainer}>
        {props.userData && <a href="/add-poll" style={style.link}>Add Poll</a>}
        {props.userData && <a href={'/user/' + JSON.parse(localStorage.getItem('userData')).local.username} style={style.link}>My Polls</a>}
